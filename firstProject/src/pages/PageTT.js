...
export default class PageTT extends React.Component {
  ...
  return (
    ...
    />
     ...
     <ImageBackground  source={require("../../assets/hell.jpg")}
            style={{width: '85%', height: '80%',
            marginLeft:50,marginTop:-300,textAlign:'center',alignContent: 'center', alignItems:'center'}}>
    ...
    marginRight: 43,
                ...
                <TouchableOpacity style= {styles.button2} >
                     <Text style={styles.txtbtt1}>Report Obstacle</Text>
                  </TouchableOpacity>
                  <TouchableOpacity style= {styles.button1} >
                     <Text style={styles.txtbtt1}>Exit</Text>
                  </TouchableOpacity>
     </ImageBackground>
     <Image
   ...
   <View style={styles.containerr}>
     ...
     <Text style={styles.txtt}>  Arrived</Text>
